    ...
    return (
        <form onSubmit={submit} className="space-y-4">
            <div>
                ...
                <TextInput id="name" type="text" value={data.name} className="mt-1 block w-full"
                    autoComplete="name" onChange={(e) => setData('name', e.target.value)} required />
            ...
            <div>
                ...
                <TextInput id="email" type="email" value={data.email} className="mt-1 block w-full"
                    autoComplete="email" onChange={(e) => setData('email', e.target.value)} required />
            ...
            <p className="text-center text-sm text-white/80">
                Já tem conta? <Link href={route('login')} className="font-semibold text-rose-300 hover:text-rose-200">Entrar</Link>
            </p>
        </form>
    );
}
